{{-- ParticlesBlock - Generated by TallCMS --}}
{{-- TODO: Add CSS styles for '.particles-block' in resources/css/blocks.css --}}
...
<section class="particles-block py-8 px-4 max-w-4xl mx-auto" style="{{ $customProperties }}">
    @if($title)
...
{{-- 
    ...
    - CSS styling defined in resources/css/blocks.css using .particles-block selector
